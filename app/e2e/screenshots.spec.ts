...
const SCREENS: [string, string][] = [['02-dashboard', '대시보드'], ['02b-chat', '내 논문'], ['03-checks', '검사 결과'], ['04-tasks', '다음 할 일'], ['05-sections', '절 목록'], ['06-outputs', '도구'], ['07-troubleshoot', '문제 해결'], ['08-settings', '설정']]
